...
export type AppEventType = "contract-category.changed" | "monthlyMemo.changed" | "site.changed" | "item.changed" | "contract.changed" | "revenue.changed" | "invoice.changed" | "monthlyClose.changed";
