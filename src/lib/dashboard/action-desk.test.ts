...
describe("dashboard action desk", () => {
  it("작성 중, 0원, 미발행 확정 매출을 각각 집계한다", () => {
    const desk = buildDashboardActionDesk([
      { revenueDate: new Date("2026-07-01T00:00:00.000Z"), salesAmount: 100_000, status: "DRAFT", invoiceLinkCount: 0 },
      { revenueDate: new Date("2026-07-02T00:00:00.000Z"), salesAmount: 0, status: "DRAFT", invoiceLinkCount: 0 },
      { revenueDate: new Date("2026-07-03T00:00:00.000Z"), salesAmount: 300_000, status: "CONFIRMED", invoiceLinkCount: 0 },
      { revenueDate: new Date("2026-07-04T00:00:00.000Z"), salesAmount: 400_000, status: "CONFIRMED", invoiceLinkCount: 1 },
      { revenueDate: new Date("2026-07-05T00:00:00.000Z"), salesAmount: 0, status: "CANCELED", invoiceLinkCount: 0 },
    ]);
