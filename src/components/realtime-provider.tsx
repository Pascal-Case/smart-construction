...
export type EventType = "monthlyMemo.changed" | "site.changed" | "item.changed" | "contract.changed" | "revenue.changed" | "invoice.changed" | "monthlyClose.changed";
...
const eventTypes: EventType[] = ["monthlyMemo.changed", "site.changed", "item.changed", "contract.changed", "revenue.changed", "invoice.changed", "monthlyClose.changed"];
